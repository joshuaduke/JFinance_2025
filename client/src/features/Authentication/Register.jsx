  ...
  return (
    <section className='h-screen relative'>
        ...
        <form action={handleSubmit} className='flex flex-col bg-white absolute bottom-0 w-full h-[60vh] px-8 rounded-tl-3xl rounded-tr-3xl'>
            <h3 className='text-center py-4 text-2xl text-slate-800'>Create an Account</h3>
            ...
            <input className='bg-white w-full border border-slate-300 shadow-md my-2 rounded-md p-2' placeholder='Confirm Password' type="password" name='confirm-password' />
            <button className='bg-blue-500 w-full text-white shadow-md my-2 rounded-md p-2' type='submit'>Sign Up </button>
            <p className='text-center text-slate-500 my-2'>Or sign up with</p>

            <button className='w-fit self-center shadow-md p-2 mt-2 mb-4  rounded-md '>
                <img src={GoogleIcon} height={20} width={20} alt="" />
            </button>
            <hr className='text-slate-300' />
            <p className='text-center text-slate-500 py-4'>Already have an account<span className='text-red-700'>Sign In</span></p>
        </form>
    </section>
  )
}
